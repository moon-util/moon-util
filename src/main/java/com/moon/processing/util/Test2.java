...
import static com.moon.processing.util.Processing2.getTypes;
...
public enum Test2 {
    ...
    public static boolean isEnum(String value) {
        return value != null && isEnum(Processing2.getUtils().getTypeElement(value));
    }
    ...
    public static boolean isSubtypeOf(TypeMirror theType, String supertype) {
        ...
        TypeElement type = Processing2.getUtils().getTypeElement(supertype);
        if (type == null) {
            return false;
        }
        return isSubtypeOf(theType, type.asType());
    }
