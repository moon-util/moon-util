...
public final class AccessorUtil {
    ...
    public static <T> PhantomAccessor<T> phantom(Supplier<T> supplier) {
        return PhantomAccessor.of(supplier);
    }

    public static <T> WeakAccessor<T> weak(Supplier<T> supplier) {
        return WeakAccessor.of(supplier);
    }

    public static <T> SoftAccessor<T> soft(Supplier<T> supplier) {
        return SoftAccessor.of(supplier);
    }

    public static <T> FinalAccessor<T> ofFinal() {
        return FinalAccessor.of();
    }

    public static <T> FinalAccessor<T> ofFinal(T value) {
        return FinalAccessor.of(value);
    }

    public static IntAccessor ofInt() {
        return IntAccessor.of();
    }

    public static IntAccessor ofInt(int value) {
    ...
    public static BooleanAccessor ofBoolean(boolean value) {
