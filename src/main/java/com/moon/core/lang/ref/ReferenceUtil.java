...
public final class ReferenceUtil {
    ...
    public static <T> Reference<T> ref(T data) {
        return weak(data);
    }

    public static <T> Reference<T> ref(T data, ReferenceQueue<? extends T> queue) {
        return weak(data, queue);
    }


    public static <T> Reference<T> weak(T obj) {
    ...
    public static <T> Reference<T> soft(T obj) {
    ...
    public static <K, V> WeakHashMap<K, V> weakMap(int initCapacity) {
