 ...
 * 此时将这个对象注解{@code MappingTarget}即可，注：
 * <ul>
 *     <li>1. 一个方法只能有一个{@code MappingTarget}</li>
 *     <li>2. 多参数方法一般建议返回值是{@code void}或{@code MappingTarget}</li>
 * </ul>
 * 例：
 * <pre>
 * &#64;BeanMapper
 ...
 *
 *     // 正确，返回{@code MappingTarget}注解的对象
